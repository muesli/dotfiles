...
PACKAGES=("${PACKAGES[@]}" "atom" "cmake" "code" "extra-cmake-modules" "git" \
    "go" "go-tools" "httpie" "js-beautify" "kdevelop" "pngcrush" "qt5-base" \
    "qt5-systems" "qt5-feedback" "qt5-xmlpatterns" "qt5-x11extras" \
